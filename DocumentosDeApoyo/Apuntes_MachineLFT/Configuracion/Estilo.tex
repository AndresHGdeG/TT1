...
\fancypagestyle{plain}{
  ...
  %-------------Imagen de pie de página pares---------%
    ...
    \fancyfoot[LE]{\begin{picture}(0,0) \put(-195,-95){ \includegraphics[scale=0.7]{Imagenes/Foot-blue.png}}\end{picture}}

  %-------------Imagen de pie de página impares---------%
    \fancyfoot[LO]{\begin{picture}(0,0) \put(-140,-95){ \includegraphics[scale=0.7]{Imagenes/Foot-blue.png}}\end{picture}}
