...
%----------------------------------TN1-------------------------------%
\begin{large}
	 \subsection{Clasificación de noticias de diarios de circulación nacional mediante aprendizaje automático }
\end{large}
...
\begin{large}
	 \subsection{Clasificación automática de textos de desastres naturales en México}
\end{large}
...
\begin{large}
	 \subsection{Usando aprendizaje automático para extraer información de noticias de desastres naturales}
\end{large}
...
\begin{large}
	 \subsection{Category classification and topic discovery of japanese and english news articles}
\end{large}
...
\begin{large}
	 \subsection{Automatic news articles classification in indonesian language by using naive bayes classifier method}
\end{large}
