...
\begin{tabular}{|l|l|}
	...
	\hline
	\textbf{Errores:} & 1. \Tref{MSG1}{MSG1 Catálago vacio}: Se muestra cuando el\\
	&catálogo \textbf{Sitios} No contiene información. \\
	&2. \Tref{MSG2}{MSG2 Lenguaje de sitio}: Se muestra cuando los sitios \\
...
\begin{enumerate}[1.]
	...
	\item \sistema Verifica que al menos un sitio cumpla con la regla de negocio \RNref{RN2}{Lenguaje de direcciones web}. \TAref{E}
	\item \sistema Incluye el caso de uso \Tref{CU2}{CU2 Recolectar noticas}.
	\item \sistema Incluye el caso de uso \Tref{CU3}{CU3 Calasificar noticias}.
	\item \finCU	
\end{enumerate}
