...
\begin{enumerate}[1.]
	...
	\item \sistema Muestra 15 noticias de las ordenadas, deacuerdo a la regla de negocio \RNref{RN11}{Orden de publicación} con la información obtenida en el paso \ref{CU1:DatosN} de la trayectoria principal, llena el campo \textbf{Fecha inicio} con lo antes calculado y el campo \textbf{Fecha fin} con la fecha actual, como se visualiza en la pantalla \Tref{UI2}{UI2 Sección política}.
