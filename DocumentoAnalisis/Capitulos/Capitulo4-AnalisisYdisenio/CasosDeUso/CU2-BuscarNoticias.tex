...
%-----------------------Salidas--------------------------------------%
	...
	&$\bullet$ \Tref{MSG3}{MSG3 Faltan campos obligatorios}\\
	&$\bullet$ \Tref{MSG4}{MSG4 Formato de fecha inválido}\\
	&$\bullet$ \Tref{MSG5}{MSG5 Periodo no válido}\\
	&$\bullet$ \Tref{MSG6}{MSG6 Lítimes fuera de rango}\\
	\hline
...
%-----Error 4----------%
	...
	&\ \ \Tref{MSG6}{MSG6 Lítimes fuera de rango} y continua en el paso \ref{CU2:FechaI} de\\
...
\begin{enumerate}[{B-}1.]
	...
	\item \sistema Muestra deshabilitado y con fechas los campos \textbf{Fecha inicio} y \textbf{Fecha fin} con lo antes calculado, como se visualiza en la pantalla \Tref{UI2}{UI2 Sección política}.
...
\textbf{Extiende a :} \Tref{CU5}{CU5 Ingresar a sitio web}\\\\