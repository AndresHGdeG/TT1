...
\begin{Large}$\mathbf{E}$\end{Large}l artículo periodístico o noticia, es la información de un hecho de interés 
  ...
  del género básico del periodismo \cite{uno}. Conocer los acontecimientos del mundo independientemente del tema, día o 
  ...
  compartirlas de una forma eficaz \cite{dos}.\\
...
(\text{Milenio}), \textbf{Adrenalina} (\text{Excelsior}), etc. Como este ejemplo se encuentran más. Las noticias son segmentadas de forma tan diversa que 
