...
\section[Matriz de confusión]{Métricas de evaluación de un modelo de aprendizaje automático}
...
La matriz de confusión es una representación de la información de los resultados obtenidos por un
...
\begin{itemize}
	...
	\item \textbf{VP}: Es la cantidad de positivos que fueron clasificados correctamente como positivos 
	\item \textbf{FN}: Es la cantidad de positivos que fueron clasificados incorrectamente como negativos
	\item \textbf{VN}: Es la cantidad de negativos que fueron clasificados correctamente como negativos
	\item \textbf{FP}: Es la cantidad de negativos que fueron clasificados incorrectamente como positivos
	
\end{itemize}


Podemos hacer más para analizar los resultados que solo medir la precisión. Si considera los posibles resultados de las clases, entonces pueden organizarse en un cuadro simple como este (donde un verdadero positivo es una observación correctamente colocada en la clase 1, mientras que un falso positivo es una observación incorrecta colocada en la clase 1, mientras que un negativo Los ejemplos (tanto verdaderos como falsos) son aquellos colocados en la clase 2):
